...
/**
 * Entry point of the 'BeanGenerator' generation module.
 *
 * @generated
 */
public class BeanGenerator extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/ustok/extgen/core/codegen/beanGenerator";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "beanGenerator" };
     ...
     * @generated
     */
    public BeanGenerator(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public BeanGenerator(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                BeanGenerator generator = new BeanGenerator(modelURI, folder, arguments);
